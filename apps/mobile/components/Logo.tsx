...
const Logo = ({
  width = 100,
  height = 100,
  color = FALLBACK_BRAND_COLOR_HEX,
  ...props
}: SvgProps) => (
  <Svg
    viewBox="0 0 615.58 732.69"
    width={width}
    height={height}
    fill="currentColor"
    color={color}
